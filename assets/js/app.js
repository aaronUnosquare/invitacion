window.addEventListener("load", () => {
  ...
  btnPlayPausa.addEventListener("click", (event) => {
    if (audio.paused) {
      ...
      btnPlayPausa.querySelector(".play").style.display = "none";
      btnPlayPausa.querySelector(".pause").style.display = "block";
    } else {
      audio.pause();

      btnPlayPausa.querySelector(".play").style.display = "block";
      btnPlayPausa.querySelector(".pause").style.display = "none";
    }
  });
});
